...
**Last updated:** 2026-06-11 · **Maintainer:** Aiden (product) + Claude Code (spec/engineering)
...
| `spec/product-spec.md` | Behavior, data model, rules, economy — *what the app does* | Claude Code | Design, Planning | **v0.15 — draft** |
| `spec/api-contract.md` | Endpoint + payload shapes — the **frontend↔backend seam** | Claude Code | Design, Planning | **v0.13 — draft** |
...
| `design/ui-design-requirements.md` | What each screen must let users *do* (derived from spec) | Claude Code → handed to Claude Design | Claude Design | **v0.11 — all screens specified** |
| `design/design-spec.md` | Screens, flows, components, visuals — *how you touch it* | Claude Design → committed here | Planning | **v0.8 — Phase B + state passes** |
