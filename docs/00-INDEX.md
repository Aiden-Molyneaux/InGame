...
| `spec/api-contract.md` | Endpoint + payload shapes — the **frontend↔backend seam** | Claude Code | Design, Planning | **v0.54 — draft** |
...
| `design/component-map.md` | UI component names → RN code (the design→code naming bridge, from M2) | Claude Design → spec-owner | Implementation | **v0.9** |
