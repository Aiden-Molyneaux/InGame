...
| [`compare-draft-b-versus.html`](compare-draft-b-versus.html) | **B · Versus / head-to-head** | *(building)* A **duel** framing: a big totals **face-off** at the top (who's ahead overall, by how much), then per-game **matchups** as comparative bars / diff rows. The **playful, competitive** pole. |
